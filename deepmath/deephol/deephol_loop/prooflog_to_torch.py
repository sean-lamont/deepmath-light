...
class ProofLogToTorch(object):
  """Class for conversion from prooflog protobuf format to torch dataset"""
...
def create_processor(
    ...
    tactics: Optional[List[deephol_pb2.Tactic]] = None) -> ProofLogToTorch:
  ...
  return ProofLogToTorch(tactics_name_id_map, theorem_database, options)
