...
# todo sexpression graph to torch
# todo for subexpression sharing: replace each node with children with the token of the first child. First child node is ignored, all edges are kept otherwise
# todo multiple roots??
