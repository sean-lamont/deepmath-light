...
from holist.models.gnn.formula_net.gnn_encoder import GNNEncoder
from .utils import pad_batch, unpad_batch
from holist.models.gnn.gnn_layers import get_simple_gnn_layer, EDGE_GNN_TYPES
...
class Attention(gnn.MessagePassing):
    ...
    def forward(self,
        ...
        if self.se == 'khopgnn':  # k-subgraph graph_benchmarks
        ...
        # for Directed attention, complete_edge_index can be changed to reflect the ancestor/descendent nodes
